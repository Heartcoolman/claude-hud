...
import { renderIdentityLine, renderProjectLine, renderAddedDirsLine, renderGitFilesLine, renderEnvironmentLine, renderPromptCacheLine, renderUsageLine, renderProxyLine, renderMemoryLine, renderSessionTokensLine, renderSessionTimeLine, } from './lines/index.js';
...
function renderElementLine(ctx, element, options) {
    ...
    switch (element) {
        ...
        case 'proxy':
            return renderProxyLine(ctx, alignProgressLabels);
        case 'promptCache':
